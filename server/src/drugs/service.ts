...
export async function lookupDrug(
  ...
  const info: DrugInfo = {
    ...
    dosing: llm?.dosingEn,
    dosingAr: llm?.dosingAr,
    sideEffects: llm?.sideEffectsEn,
    sideEffectsAr: llm?.sideEffectsAr,
    contraindications: llm?.contraindicationsEn,
    contraindicationsAr: llm?.contraindicationsAr,
